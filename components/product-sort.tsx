  ...
  return (
    <div className="flex items-center">
      <Select onValueChange={value=> router.replace(value)}>
        ...
        <SelectContent>
          {/* recordamos que cada vez que queramos elegir una opcion no podremos usar un hook al ser un server component , asi que tendremos que cambiar la url por ej con las opciones de sortby */}
